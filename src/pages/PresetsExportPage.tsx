...
export function PresetsExportPage() {
  ...
  const savePreset = () => {
    ...
    try {
      ...
      const config = ColorJourneyConfigSchema.parse(parsedJson.config || parsedJson) as unknown as ColorJourneyConfig;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-8 md:py-10 lg:py-12">
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-balance leading-tight bg-clip-text text-transparent bg-gradient-hero bg-[length:200%_100%] animate-gradient-shift">Presets & Export</h2>
